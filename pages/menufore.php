...
<main>
    <section class="product-details">
        ...
        <form action="../pages/keranjang.php" method="POST">
            <div class="product">
                <div class="product-image">
                    <img src="../images/kopisusu.png" alt="Nasi Padang">
                </div>
                <div class="product-info">
                    <h3>Aren Latte</h3>
                    <p>Kopi Susu dengan tambahan gula aren asli</p>
                    <p class="price">Rp. 29.000,00</p>
                    <div class="product-actions">
                        ...
                        <input type="hidden" name="item_name" value="Aren Latte">
                        <input type="hidden" name="item_price" value="29000">
        ...
        <form action="../pages/keranjang.php" method="POST">
            <div class="product">
                <div class="product-image">
                    <img src="../images/miloklasik.png" alt="Nasi Uduk">
                </div>
                <div class="product-info">
                    <h3>Classic Milo</h3>
                    <p>Susu Milo dengan Campuran Coklat</p>
                    ...
                    <div class="product-actions">
                        ...
                        <!-- Input tersembunyi untuk nama item dan harga -->
                        <input type="hidden" name="item_name" value="Classic Milo">
